...
public class TestStanford
{
	...
	public void runTests() {
		...
		// pass.
		rc &= test_sentence ("Who invented sliced bread?",
			"nsubj(invented-2, who-1)\n" +
			"amod(bread-4, sliced-3)\n" + 
			"dobj(invented-2, bread-4)");

		rc &= test_sentence ("Jim runs quickly.",
			"nsubj(runs-2, Jim-1)\n" +
			"advmod(runs-2, quickly-3)");

		rc &= test_sentence ("The bird, a robin, sang sweetly.",
			"det(bird-2, the-1)\n" +
			"nsubj(sang-7, bird-2)\n" +
			"det(robin-5, a-4)\n" +
		...
		rc &= test_sentence ("There is a place we can go.",
			"expl(is-2, there-1)\n" +
			"det(place-4, a-3)\n" +
			"nsubj(is-2, place-4)\n" +
			"nsubj(go-7, we-5)\n" +
		...
		rc &= test_sentence ("The linebacker gave the quarterback a push.",
		...
		rc &= test_sentence ("He stood at the goal line.",
			"nsubj(stood-2, he-1)\n" +
			"det(line-6, the-4)\n" +
			"nn(line-6, goal-5)\n" +
		...
		rc &= test_sentence ("She looks very beautiful.",
			"nsubj(looks-2, she-1)\n" +
			"advmod(beautiful-4, very-3)\n" +
			"acomp(looks-2, beautiful-4)");

		// advcl example from Stanford docs
		rc &= test_sentence ("The accident happened as the night was falling.",
		...
		// advcl example from Stanford docs
		rc &= test_sentence ("If you know who did it, you should tell the teacher.",
			"mark(know-3, if-1)\n" +
			"nsubj(know-3, you-2)\n" +
		...
		rc &= test_sentence ("The man has been killed by the police.",
			"det(man-2, the-1)\n" +
		...
		rc &= test_sentence ("Effects caused by the protein are important.",
		...
		rc &= test_sentence ("Sam, my brother, has arrived.",
			"nsubj(arrived-7, Sam-1)\n" +
			"poss(brother-4, my-3)\n" +
			"appos(Sam-1, brother-4)\n" +
			"aux(arrived-7, has-6)");

		rc &= test_sentence ("What is that?",
			"attr(is-2, what-1)\n" +
			"nsubj(is-2, that-3)");

		rc &= test_sentence ("Reagan has died.",
			"nsubj(died-3, Reagan-1)\n" +
			"aux(died-3, has-2)");

		rc &= test_sentence ("He should leave.",
			"nsubj(leave-3, he-1)\n" +
			"aux(leave-3, should-2)");

		rc &= test_sentence ("Kennedy has been killed.",
			"nsubjpass(killed-4, Kennedy-1)\n" +
			"aux(killed-4, has-2)\n" +
			"auxpass(killed-4, been-3)");

		rc &= test_sentence ("Kennedy was killed.",
			"nsubjpass(killed-3, Kennedy-1)\n" +
			"auxpass(killed-3, was-2)");

		rc &= test_sentence ("Kennedy got killed.",
			"nsubjpass(killed-3, Kennedy-1)\n" +
			"auxpass(killed-3, got-2)");

		rc &= test_sentence ("Bill is big.",
			"nsubj(big-3, Bill-1)\n" +
			"cop(big-3, is-2)\n");

		rc &= test_sentence ("Bill is an honest man.",
			"nsubj(man-5, Bill-1)\n" +
			"cop(man-5, is-2)\n" +
			"det(man-5, an-3)\n" +
			"amod(man-5, honest-4)");

		rc &= test_sentence ("What she said makes sense.",
			"dobj(said-3, what-1)\n" +
			"nsubj(said-3, she-2)\n" +
			"csubj(makes-4, said-3)\n" +
			"dobj(makes-4, sense-5)");

		rc &= test_sentence ("What she said is not true.",
			"dobj(said-3, what-1)\n" +
			"nsubj(said-3, she-2)\n" +
			"csubj(true-6, said-3)\n" +
			"cop(true-6, is-4)\n" +
		...
		rc &= test_sentence ("Which book do you prefer?",
			"det(book-2, which-1)\n" +
			"dobj(prefer-5, book-2)\n" +
			"aux(prefer-5, do-3)\n" +
			"nsubj(prefer-5, you-4)");

		rc &= test_sentence ("There is a ghost in the room.",
			"expl(is-2, there-1)\n" +
			"det(ghost-4, a-3)\n" +
			"nsubj(is-2, ghost-4)\n" +
			"det(room-7, the-6)\n" +
		...
		rc &= test_sentence ("She gave me a raise.",
			"nsubj(gave-2, she-1)\n" +
			"iobj(gave-2, me-3)\n" +
			"det(raise-5, a-4)\n" +
			"dobj(gave-2, raise-5)");

		rc &= test_sentence ("The director is 65 years old.",
		...
		rc &= test_sentence ("Sam eats 3 sheep.",
			"nsubj(eats-2, Sam-1)\n" +
			"num(sheep-4, 3-3)\n" +
			"dobj(eats-2, sheep-4)");
 ...
 * I don't get it. Stanford makes a num/number distinction I can't grok.
		rc &= test_sentence ("I lost $ 3.2 billion.",
			"nsubj(lost-2, I-1)\n" +
			"dobj(lost-2, $-3)\n" +
			"number($-3, 3.2-4)\n" +
			"number($-3, billion-5)");
***********/
		...
		rc &= test_sentence ("Truffles picked during the spring are tasty.",
 ...
 *
		rc &= test_sentence ("We went to their offices to get Bill's clothes.",
			"nsubj(went-2, we-1)\n" +
			"xsubj(get-7, we-1)\n" +
 ...
 * See README-Stanford for details.
		rc &= test_sentence ("All the boys are here.",
			"predet(boys-3, all-1)\n" +
			"det(boys-3, the-2)\n" +
			"nsubj(are-4, boys-3)\n" +
			"advmod(are-4, here-5)");
 ...
 * See the README-Stanford for a discussion.
		rc &= test_sentence ("I saw a cat in a hat.",
			"nsubj(saw-2, I-1)\n" +
			"det(cat-4, a-3)\n" +
			"dobj(saw-2, cat-4)\n" +
			"det(hat-7, a-6)\n" +
		...
		rc &= test_sentence ("I saw a cat with a telescope.",
			"nsubj(saw-2, I-1)\n" +
			"det(cat-4, a-3)\n" +
			"dobj(saw-2, cat-4)\n" +
			"det(telescope-7, a-6)\n" +
...
***********/
		...
		rc &= test_sentence ("He is responsible for meals.",
			"nsubj(responsible-3, he-1)\n" +
			"cop(responsible-3, is-2)\n" +
			"prep_for(responsible-3, meals-5)\n");

		rc &= test_sentence ("They shut down the station.",
			"nsubj(shut-2, they-1)\n" +
			"prt(shut-2, down-3)\n" +
			"det(station-5, the-4)\n" +
			"dobj(shut-2, station-5)");

		rc &= test_sentence ("About 200 people came to the party.",
		...
		rc &= test_sentence ("I saw the man who you love.",
			"nsubj(saw-2, I-1)\n" +
			"det(man-4, the-3)\n" +
			"dobj(saw-2, man-4)\n" +
			"dobj(love-7, man-4)\n" +
...
rcmod(man-4, love-8)
		...
		rc &= test_sentence ("I saw the man whose wife you love.",
			"nsubj(saw-2, I-1)\n" +
			"det(man-4, the-3)\n" +
			"dobj(saw-2, man-4)\n" +
			"poss(wife-6, whose-5)\n" +
...
***********/
		...
		rc &= test_sentence ("I am ready to leave.",
			"nsubj(ready-3, I-1)\n" +
			"cop(ready-3, am-2)\n" +
			"aux(leave-5, to-4)\n" +
			"xcomp(ready-3, leave-5)");

		rc &= test_sentence ("Tom likes to eat fish.",
			"nsubj(likes-2, Tom-1)\n" +
			"xsubj(eat-4, Tom-1)\n" +
			"aux(eat-4, to-3)\n" +
			"xcomp(likes-2, eat-4)\n" +
...
/****************
		rc &= test_sentence ("He says that you like to swim.",
			"nsubj(says-2, he-1)\n" +
...
/****************
		rc &= test_sentence ("The garage is next to the house.",
			"det(garage-2, the-1)\n" +
...
***********/
		...
		// =========================================================
		//
		rc &= test_tagged_sentence ("Truffles picked during the spring are tasty.",
		...
		// either.
		rc &= test_tagged_sentence ("There was a time when we were young.",
		...
		rc &= test_tagged_sentence ("Is there a better way?",
			"expl(is-1-VBZ, there-2-EX)\n" +
			"det(way-5-NN, a-3-DT)\n" +
			"amod(way-5-NN, better-4-JJR)\n" +
			"nsubj(is-1-VBZ, way-5-NN)");

		rc &= test_tagged_sentence ("Is this the largest you can find?",
		...
		rc &= test_tagged_sentence ("But my efforts to win his heart have failed.",
		...
		rc &= test_tagged_sentence ("The undergrads are occasionally late.",
			"det(undergrads-2-NNS, the-1-DT)\n" +
			"nsubj(late-5-JJ, undergrads-2-NNS)\n" +
			"cop(late-5-JJ, are-3-VBP)\n" +
			"advmod(late-5-JJ, occasionally-4-RB)");

		rc &= test_tagged_sentence ("The height of Mount Everest is 8,848 metres.",
		...
		rc &= test_tagged_sentence ("It happened on December 3rd, 1990.",
